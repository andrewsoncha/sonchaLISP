...
void init(){
	defineStdFunction(add, "add", "Sum of all arguments");
	defineStdFunction(sub, "sub","1st argument Subtracted by all other arguments");
	defineStdFunction(mult, "mult", "Product of all arguments");
	defineStdFunction(divide, "div", "1st argument Divided by all other arguments");
